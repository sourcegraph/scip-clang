...
def fetch_direct_dependencies():
    ...
    http_file(
        ...
        executable = True,
        sha256 = "afb78f350319b59cc51d6add3a5f3ba68e63e5d88f68c5a9ea6328a07084d319",
        urls = ["https://github.com/bazelbuild/buildtools/releases/download/v10.0.1/buildifier-darwin-arm64"],
    )
