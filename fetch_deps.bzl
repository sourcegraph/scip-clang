...
def fetch_direct_dependencies():
    ...
    http_file(
        ...
        executable = True,
        sha256 = "e0ea28e2d639347724435ebafe0531fd764fbf20eec6a23000c81edd0d58e51d",
        urls = ["https://github.com/bazelbuild/buildtools/releases/download/v10.0.1/buildifier-linux-amd64"],
    )
